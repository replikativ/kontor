(ns kontor.sole-proprietor
   ...
   *only* the business, with no personal accounts at all — and that is
   ...
   `kontor.personal-income-tax` provider call as an addition to the
   ...
   `kontor.report/marginalize`, the tax providers and
   `kontor.vat-return` already exist; this namespace is the thin
...
(defn business-income-input
  "Fold a sole proprietor's `business-net` into the `:inputs` of a
   `kontor.personal-income-tax` provider call — the business net joins

...
- [x] **Stage K — kontor-procurement** — Full P2P + reverse flow. ADR-042 design (`a08c239`) + 4 implementation commits: schema/seeds (`35fcf12`), forward 3-way match + bridge polymorphism (`16a7f4a`), reverse flow + credit-memo (`2e570d8`), drop-ship + `:order-item-assoc` (`1b69e06`). 708 tests / 2554 assertions baseline. Review-after agents (code-review + market-pain delta) running.

...
This invariant is **grammar, not physics**. It
...
the quotient epimorphism `σ_E`: partition the
...
## 5. What kontor keeps and drops from the "future of accounting"

kontor's design was cross-checked against Dave McComb & Cheryl Dunn's
*The Future of Accounting*. McComb argues
...
keeping it re-derivable.

## 6. What kontor *is*, in one line
...
- [decisions.md](decisions.md) — every locked choice. ADR-095..097 are
  this model's verbs / report engine / dimensions.
- [programming.md](programming.md) — the transact gate, status
  machines, the bitemporal substrate, in code.
- [README](../README.md) — the evaluator-facing What/What-NOT/Status.

...
(ns showcases.06-de-gmbh-multi-year
  "Multi-national use case 6: Acme Manufacturing GmbH (München) —
   ...
   Note this showcase deliberately SKIPS several pieces — asset
   depreciation, lease IFRS 16, parallel-ledger Steuerbilanz
   reconciliation, UStVA amendment — to keep the notebook focused
   on the load-bearing substrate demonstration. Those are exercised
   in their own per-module e2e tests (kontor-asset / kontor-lease /

...
(ns showcases.05-apple-10k-bitemporal
  "Multi-national use case 5: Apple Inc.'s 2009 10-K bitemporal
   ...
   Sources cited:
     ...
     - Research note 91 §2 (EDGAR research-before)
     - Research note 78 (XBRL primer)"
...
;;   for FDTA municipal filings (note 91 §10), Companies House,
...
;; - SEC requires a `User-Agent` header on API requests (note 91 §10
;;   gotcha); consumers downloading at ingest time set

(ns kontor.provider.costing-provider-test
...
(deftest provider-for-builds-known-impls
  (is (instance? kontor.provider.costing_provider.FIFOCostingProvider
                 (costing/provider-for :fifo)))
  (is (instance? kontor.provider.costing_provider.LIFOCostingProvider
                 (costing/provider-for :lifo)))
  (is (instance? kontor.provider.costing_provider.WeightedAverageProvider
                 (costing/provider-for :avg)))
  (is (instance? kontor.provider.costing_provider.StandardCostProvider

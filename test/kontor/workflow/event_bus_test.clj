(ns kontor.workflow.event-bus-test
  "Tests for `kontor.workflow.event-bus` (ADR-092) — McComb-aligned in-process
   ...
   - `commit-and-emit` integrates with `kontor.workflow.process/run-process`.

(ns kontor.hr.person
  "kontor-hr :person transactors — the human-identity root.
   ...
   employing :entity per ADR-031 + note 79 Call 2). See
   [[doc/research/79-hr-payroll-stage-r-plan]] §2.1–§2.3 for the
   substrate-vs-companion rationale.
  ...
  "Pure tx-data builder for `create-person!`. Optional `:tempid`
   ...
   Optional keys:
     ...
     :kind          — :employee (default) | :contingent | :applicant |
                      :retiree | :board-member | :intern (note 81 §9.7)"

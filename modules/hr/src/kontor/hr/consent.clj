...
(defn active-at?
  "Was a consent for `(subject, scope)` operationally in force at
   ...
   `kontor.compliance.audit-doc/canonical-categories`). Returns a boolean.

(ns kontor.l10n-at.investment-income-statute
  "AT investment-income tax — KESt on dividends (§27a Abs 1 Z 2 EStG —
   ...
   corporate participation exemption — encoded as `kontor.tax.statute`
   data per ADR-101. 

   THE KEY INSIGHT: every KESt rate this provider needs
...
(def provisions
  "AT investment-income statutory provisions. Empty for v1 — every AT
   ...
   - §10 foreign-corp guard (per AT CGT,.2): when

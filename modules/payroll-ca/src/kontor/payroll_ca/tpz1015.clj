(ns kontor.payroll-ca.tpz1015
  "TPZ-1015 — Revenu Québec monthly / quarterly / annual source-deduction
   remittance helper. The Quebec equivalent of CRA's PD7A: kontor sums
   the Revenu Québec liability buckets for a remittance
   ...
   Reference:(pattern) + §8.1 (the QC parallel)."

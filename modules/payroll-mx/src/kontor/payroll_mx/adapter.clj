(ns kontor.payroll-mx.adapter
  "Bridge layer wiring MX-private engine/emitter protocols into the
   kernel-substrate `kontor.provider.payroll-provider` PayrollProvider trio
   ...
   (`kontor.provider.payroll-provider/PayrollComputeProvider` +
   ...
   - `:kontor.audit-doc/category :payroll-filing` is canonical.

(ns kontor.l10n-au.cgt-statute
  "AU capital-gains tax — Subdivision 115 discount, Subdivision 152 small-
   ...
   - **Discount sunset** — 1 July 2027 cutover for individuals / trusts
     (the 2026-27 federal-budget reform;.4).

   The Subdivision 152 cascade itself is PROVIDER-INTERNAL LOGIC, not
   ADR-101 provisions — the cascade is a taxpayer-elected
   ...
   TODO: the 30% minimum-effective-rate floor for
...
(def parameter-values
  "AU CGT parameter values. Sources:
     ...
     - s152-305 retirement cap — frozen at $500 000 (changed from
       $200 000 to $500 000 effective 2007-07-01 via
...
(def provisions
  "AU CGT provisions — empty for v1.
   ...
   all PROVIDER-INTERNAL LOGIC per research
   ...
   Future work: the 30 % minimum-effective-rate floor

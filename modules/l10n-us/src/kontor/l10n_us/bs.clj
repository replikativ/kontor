...
;; See the note in kontor.l10n-us.pnl — the kernel report engine defaults
;; a line's commodity to :EUR, so a USD book gets correct numbers under
;; the wrong currency tag unless every line says otherwise.

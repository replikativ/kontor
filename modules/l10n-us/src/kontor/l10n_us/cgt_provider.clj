(ns kontor.l10n-us.cgt-provider
  "US capital-gains tax provider — `PeriodTaxProvider` (ADR-099) over
   ...
   `kontor.tax.sole-proprietor` (ADR-100) between business-net and PIT.
...
(defn register!
  "Register US-specific compute-fns with `kontor.tax.statute`. Called at
...
(defn us-individual-cgt-provider
  "Build a US individual CGT provider. Required: `:source` — a
   ...
   US investment-income provider that owns NIIT."

(ns kontor.l10n-us.cgt-provider-test
  "Tests for the US CGT provider (ADR-102 + ADR-101)."
...
(defn- run-provider
  ...
  (let [source ((case kind :individual disp-provider/datahike-provider
                      :corporation disp-provider/datahike-provider) conn)
        provider (case kind
...
;; ============================================================================
;; §1. Plumbing — DisposalProvider, empty case, kind validation
;; ============================================================================

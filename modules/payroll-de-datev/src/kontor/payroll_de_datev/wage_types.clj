(ns kontor.payroll-de-datev.wage-types
  "Wage-type catalog shape + default SKR04 / SKR03 account map for the
   DE-DATEV-LODAS adapter (ADR-076 / research.4 + §9.2).
...
;; ============================================================================
;; The 10 load-bearing payroll accounts
;; ============================================================================

(def default-account-map-skr04
  "account-hint → SKR04 4-digit Konto. Starter set; consumers extend
   / override.

   SKR04 numbering per the public DATEV cooperative chart."
...
;; ============================================================================
;; Allowed :kind sets per Lohnart range conventions
;; ============================================================================
...
(defn lookup-wage-type
  "Lookup a LODAS Lohnart-Nr in the catalog. Returns nil if not mapped
   (consumer routes unmapped to a manual-review queue
   §6.3.5)."

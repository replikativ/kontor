(ns kontor.payroll-de-datev.posting-builder
  "DATEV LODAS payroll → SKR04 / SKR03 GL posting builder
   ...
   suitable PTO accrual sketched in note 82 §5.1. Larger employers
   override the algorithm; pensions (note 82 §5.3) stay
...
;; ============================================================================
;; HGB §249 — Urlaubsrückstellung (PTO accrual) — note 82 §5.1
;; ============================================================================

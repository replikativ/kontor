...
(defn uk-income-tax-allocation
  "Implements ITA 2007 §16 ordering. Pure function over BigDecimal.
   ...
   The function does NOT honour PA tapering above £100k — that's a UK
   PIT provider concern. v1 callers pre-adjust `:non-savings` if PA
   tapering applies."
...
(def ^:private tag-lanes
  "The closed v1 tag set this provider recognises.
...
5 the substrate convention is the consumer keeps

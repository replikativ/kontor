(ns kontor.l10n-uk.cgt-statute
  "UK capital-gains tax — TCGA 1992 (individuals) + chargeable-gains
   feeder into Corporation Tax (CTA 2010) — encoded as `kontor.tax.statute`
   data per ADR-101. 
...
(def parameter-values
  ...
  [;; --- AEA timeline ---------------------------------------------------------
   ...
   ;; (Finance Bill 2024-25). £1M post Oct-2024.

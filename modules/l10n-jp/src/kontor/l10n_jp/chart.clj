(ns kontor.l10n-jp.chart
  "Japanese chart-of-accounts loader.
   ...
   This chart is a starting point that businesses extend; J-GAAP does
   not mandate a specific account list. The included accounts cover the
   common shape needed to support consumption tax (JCT) at both rates
   and the QIS-compliant invoicing.

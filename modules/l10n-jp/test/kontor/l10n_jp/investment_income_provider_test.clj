(ns kontor.l10n-jp.investment-income-provider-test
  "Tests for the JP investment-income provider (research note 151).
   ...
   - Worked examples from note 151 §2 (Mr Tanaka, Mr Suzuki)."
...
;; ============================================================================
;; §9. Mr Suzuki mixed-portfolio worked example (note 151 §2.2)
;; ============================================================================

(deftest mr-suzuki-mixed-portfolio
  (testing "note 151 §2.2 — multi-lane fan-out + NISA exemption + foreign credit"
    (let [conn (fresh)
          ;; The full Mr Suzuki portfolio from note 151 §2.

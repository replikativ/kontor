(ns kontor.payroll-us-adp.wage-types
  "Consumer-extensible wage-type catalog shape (ADR-077).
   ...
   same reason `kontor.tax-rate-provider` ships abstract: every
   ...
   public ADP wage-type labels (Microsoft 'Payroll Connect for GP'
   spec, public ADP admin-portal documentation)."

(ns kontor.l10n-fr.cit-provider-test
  "FR corporate income tax provider tests — ADR-101 substrate's FR
   ...
   `kontor.statute/apply-provisions` fold) computes real FR IS against
   ...
   - **§2 PME 15 %/25 % + CGE** — note 109 §2 canonical case: SAS with
     CA HT €8 M, fully paid capital, 80 % held by individuals,
     bénéfice fiscal €4 M; CGE fires because CA HT ≥ €7.63 M.
     Total €1,003,430.75 (note 109 rounded to €1,003,431 — we keep the
     exact computation).
...
;; ============================================================================
;; §2. PME 15 % / 25 % + CGE — the note 109 §2 canonical worked example
;; ============================================================================

(deftest pme-15-25-with-cge-note-109-worked-example
  (testing "SAS, CA HT €8 M (PME-eligible, NOT CGE-exempt because CA HT ≥ €7.63 M);
            bénéfice fiscal €4 M; total €1,003,430.75 (note 109 §2 rounded €1,003,431)"
...
;; ============================================================================
;; §5. PME smaller — note 109 §2 first row (CGE does NOT fire)
;; ============================================================================

(deftest pme-without-cge-when-is-below-abattement
  (testing "note 109 §2 first table: SAS PME, CA HT €8 M, bénéfice €3 M;

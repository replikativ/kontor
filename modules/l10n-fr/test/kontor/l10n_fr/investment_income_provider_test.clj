...
;; ============================================================================
;; §2. Barème election + 40 % abattement on €20k dividend
;; ============================================================================

(deftest bareme-election-with-40pct-abattement
  (testing "€20k dividend under barème: 40% abattement → 60% base"
    (let [conn (fresh)
          facts (run-personal conn
...
;; ============================================================================
;; §5. Intérêts — PFU + low-RFR dispense
;; ============================================================================

(deftest interets-pfu-no-pas
  (testing "€800 interest, PFU default (no PAS dispense)"
    (let [conn (fresh)
          facts (run-personal conn
...
;; ============================================================================
;; §7. Mère-fille corporate
;; ============================================================================

(deftest mere-fille-95pct-exemption-5pct-qpfc
  (testing "€500k dividend mère-fille: €25k QPFC (5 %) → CIT base addition"
    (let [conn (fresh)

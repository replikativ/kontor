(ns kontor.sales
  "Public surface of the `kontor-sales` companion — ADR-035.
   ...
   Resolution, status transitions (via kontor.workflow.status-machine + the
...
;; ============================================================================
;; Status transitions — wrappers over kontor.workflow.status-machine
;; ============================================================================
...
;; ============================================================================
;; Header promotion — promote the header when all line items are settled
;; ============================================================================
...
;; ============================================================================
;; Recalc pipeline — composable order processors
;; ============================================================================
...
(defn register-processor!
  "Register a recalc processor. A processor is a fn `(fn [conn order-eid] tx-data)`
   ...
   The kernel ships no built-in processors; consumers register
   tax / promotion / shipping processors per their domain.

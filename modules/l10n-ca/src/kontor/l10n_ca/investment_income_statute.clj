...
(def parameter-values
  ...
  [;; Eligible gross-up — 1.38× since 2014-01-01 (was 1.45× 2009-2013).
   ...
   {:kontor.parameter-value/parameter      [:kontor.parameter/code "CA.ON.InvIncome.dtc-eligible-rate"]
    ...
    :kontor.parameter-value/citation       "Ontario eligible DTC 10.0% of grossed-up (TaxTips.ca DTC tables; KPMG Tax Facts 2025-2026)"}
   ...
   {:kontor.parameter-value/parameter      [:kontor.parameter/code "CA.BC.InvIncome.dtc-eligible-rate"]
    ...
    :kontor.parameter-value/citation       "BC eligible DTC 12.0% of grossed-up since 2019 (TaxTips.ca DTC tables)"}
   ...
   {:kontor.parameter-value/parameter      [:kontor.parameter/code "CA.AB.InvIncome.dtc-eligible-rate"]
    ...
    :kontor.parameter-value/citation       "Alberta eligible DTC 8.12% of grossed-up (TaxTips.ca — long-stable; matches note 152 §1.4 table)"}
   ...
   {:kontor.parameter-value/parameter      [:kontor.parameter/code "CA.QC.InvIncome.dtc-eligible-rate"]
    ...
    :kontor.parameter-value/citation       "Quebec eligible DTC 11.70% of grossed-up since 2022 (TaxTips.ca QC table)"}

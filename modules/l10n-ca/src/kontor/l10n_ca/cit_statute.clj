(ns kontor.l10n-ca.cit-statute
  "CA corporate income tax — federal T2 Part I + per-province CIT —
   encoded as `kontor.statute` data per ADR-101 / ADR-107. Sibling of
   ...
   `:provision/concept` references the seeded `:tax-concept`s
...
(def parameters
  "CA CIT parameter definitions — one row per `:parameter/code`. Values
   live in `parameter-values` keyed by `:effective-from`."
  [;; --------------------------------------------------------------------
   ;; Federal
   ;; --------------------------------------------------------------------
   {:parameter/code         "CA.Federal.CIT.base-rate"
    :parameter/label        "ITA §123 — basic federal corporate income tax rate (38%, before reductions)"
    :parameter/jurisdiction :ca
    :parameter/unit         :rate
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-123.html"}

   {:parameter/code         "CA.Federal.CIT.provincial-abatement"
    :parameter/label        "ITA §124 — 10% provincial abatement on income earned in a province"
    :parameter/jurisdiction :ca
    :parameter/unit         :rate
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-124.html"}

   {:parameter/code         "CA.Federal.CIT.general-reduction"
    :parameter/label        "ITA §123.4 — General Tax Reduction (−13%)"
    :parameter/jurisdiction :ca
    :parameter/unit         :rate
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-123.4.html"}

   {:parameter/code         "CA.Federal.CIT.sbd-rate"
    :parameter/label        "ITA §125 — Small Business Deduction effective rate (9% on first $500k for CCPCs)"
    :parameter/jurisdiction :ca
    :parameter/unit         :rate
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-125.html"}

   {:parameter/code         "CA.Federal.CIT.general-rate"
    :parameter/label        "Effective general federal rate: 38 − 10 − 13 = 15%"
    :parameter/jurisdiction :ca
    :parameter/unit         :rate
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-123.4.html"}

   {:parameter/code         "CA.Federal.CIT.sbd-business-limit"
    :parameter/label        "ITA §125(2) — annual business limit for SBD ($500k)"
    :parameter/jurisdiction :ca
    :parameter/unit         :amount-money
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-125.html"}

   {:parameter/code         "CA.Federal.SRED.ccpc-refundable-rate"
    :parameter/label        "ITA §127.1 — SR&ED 35% refundable ITC for CCPCs (on first $3M of qualifying expenditures)"
    :parameter/jurisdiction :ca
    :parameter/unit         :rate
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-127.1.html"}

   {:parameter/code         "CA.Federal.SRED.standard-rate"
    :parameter/label        "ITA §127(5) — SR&ED 15% non-refundable ITC (non-CCPC + excess CCPC)"
    :parameter/jurisdiction :ca
    :parameter/unit         :rate
    :parameter/concept-iri  "https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-127.html"}

   {:parameter/code         "CA.Federal.SRED.ccpc-expenditure-limit"
    :parameter/label        "ITA §127.1 — SR&ED CCPC enhanced-rate expenditure limit ($3M; raised to $6M for tax years beginning after 2024-12-15)"
    :parameter/jurisdiction :ca
    :parameter/unit         :amount-money
    :parameter/concept-iri  "https://www.canada.ca/en/revenue-agency/services/scientific-research-experimental-development-tax-incentive-program/investment-tax-credit-policy.html"}

   ;; --------------------------------------------------------------------
   ;; Ontario
   ;; --------------------------------------------------------------------
   {:parameter/code         "CA.ON.CIT.general-rate"
    :parameter/label        "Ontario Taxation Act 2007 §29 — general corporate income tax rate (11.5%)"
    :parameter/jurisdiction :ca-on
    :parameter/unit         :rate
    :parameter/concept-iri  "https://www.ontario.ca/laws/statute/07t11"}

   {:parameter/code         "CA.ON.CIT.sbd-rate"
    :parameter/label        "Ontario Taxation Act 2007 §31 — small-business corporate income tax rate (3.2%)"
    :parameter/jurisdiction :ca-on
    :parameter/unit         :rate
    :parameter/concept-iri  "https://www.ontario.ca/laws/statute/07t11"}

   {:parameter/code         "CA.ON.CIT.sbd-limit"
    :parameter/label        "Ontario small-business limit ($500k, matches federal)"
    :parameter/jurisdiction :ca-on
    :parameter/unit         :amount-money
    :parameter/concept-iri  "https://www.ontario.ca/laws/statute/07t11"}
   ...
   ;; British Columbia
   ;; --------------------------------------------------------------------
   {:parameter/code         "CA.BC.CIT.general-rate"
    :parameter/label        "BC Income Tax Act §14 — general corporate income tax rate (12%)"
    :parameter/jurisdiction :ca-bc
    :parameter/unit         :rate
    :parameter/concept-iri  "https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96215_01"}

   {:parameter/code         "CA.BC.CIT.sbd-rate"
    :parameter/label        "BC Income Tax Act §14 — small-business corporate income tax rate (2%)"
    :parameter/jurisdiction :ca-bc
    :parameter/unit         :rate
    :parameter/concept-iri  "https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96215_01"}

   {:parameter/code         "CA.BC.CIT.sbd-limit"
    :parameter/label        "BC small-business limit ($500k, matches federal)"
    :parameter/jurisdiction :ca-bc
    :parameter/unit         :amount-money
    :parameter/concept-iri  "https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96215_01"}
   ...
   ;; Alberta
   ;; --------------------------------------------------------------------
   {:parameter/code         "CA.AB.CIT.general-rate"
    :parameter/label        "Alberta Corporate Tax Act §21 — general corporate income tax rate (8%)"
    :parameter/jurisdiction :ca-ab
    :parameter/unit         :rate
    :parameter/concept-iri  "https://kings-printer.alberta.ca/1266.cfm?page=A15.cfm&leg_type=Acts"}

   {:parameter/code         "CA.AB.CIT.sbd-rate"
    :parameter/label        "Alberta small-business CIT rate (2%)"
    :parameter/jurisdiction :ca-ab
    :parameter/unit         :rate
    :parameter/concept-iri  "https://kings-printer.alberta.ca/1266.cfm?page=A15.cfm&leg_type=Acts"}

   {:parameter/code         "CA.AB.CIT.sbd-limit"
    :parameter/label        "Alberta small-business limit ($500k, matches federal)"
    :parameter/jurisdiction :ca-ab
    :parameter/unit         :amount-money
    :parameter/concept-iri  "https://kings-printer.alberta.ca/1266.cfm?page=A15.cfm&leg_type=Acts"}])
...
(def parameter-values
  "CA CIT parameter values with their statutory effective windows.
   Provincial rates verified TY2024-2025 per
  ...
  [;; --------------------------------------------------------------------
   ...
   ;; --------------------------------------------------------------------
   {:parameter-value/parameter      [:parameter/code "CA.Federal.CIT.base-rate"]
    :parameter-value/effective-from #inst "1972-01-01"
    :parameter-value/decimal-value  0.38M
    :parameter-value/citation       "ITA §123(1)(a) — basic rate stable since the 1972 reform"}

   {:parameter-value/parameter      [:parameter/code "CA.Federal.CIT.provincial-abatement"]
    :parameter-value/effective-from #inst "1972-01-01"
    :parameter-value/decimal-value  0.10M
    :parameter-value/citation       "ITA §124(1) — 10% provincial abatement"}

   {:parameter-value/parameter      [:parameter/code "CA.Federal.CIT.general-reduction"]
    :parameter-value/effective-from #inst "2012-01-01"
    :parameter-value/decimal-value  0.13M
    :parameter-value/citation       "ITA §123.4(2) — General Tax Reduction stable at 13% since 2012"}

   {:parameter-value/parameter      [:parameter/code "CA.Federal.CIT.sbd-rate"]
    :parameter-value/effective-from #inst "2019-01-01"
    :parameter-value/decimal-value  0.09M
    :parameter-value/citation       "ITA §125 — SBD effective rate 9% since 2019 (was 10% 2018, 10.5% 2017)"}

   {:parameter-value/parameter      [:parameter/code "CA.Federal.CIT.general-rate"]
    :parameter-value/effective-from #inst "2012-01-01"
    :parameter-value/decimal-value  0.15M
    :parameter-value/citation       "Effective general federal rate (38 − 10 − 13 = 15%) since 2012"}

   {:parameter-value/parameter      [:parameter/code "CA.Federal.CIT.sbd-business-limit"]
    :parameter-value/effective-from #inst "2009-01-01"
    :parameter-value/decimal-value  500000M
    :parameter-value/citation       "ITA §125(2) — annual business limit $500k since 2009"}

   {:parameter-value/parameter       [:parameter/code "CA.Federal.SRED.ccpc-refundable-rate"]
    :parameter-value/effective-from  #inst "1985-01-01"
    :parameter-value/decimal-value   0.35M
    :parameter-value/citation        "ITA §127.1 — 35% refundable ITC for CCPCs"}

   {:parameter-value/parameter      [:parameter/code "CA.Federal.SRED.standard-rate"]
    :parameter-value/effective-from #inst "2014-01-01"
    :parameter-value/decimal-value  0.15M
    :parameter-value/citation       "ITA §127(5) — standard SR&ED ITC reduced from 20% to 15% effective 2014"}

   {:parameter-value/parameter       [:parameter/code "CA.Federal.SRED.ccpc-expenditure-limit"]
    :parameter-value/effective-from  #inst "2010-01-01"
    :parameter-value/effective-until #inst "2024-12-15"
    :parameter-value/decimal-value   3000000M
    :parameter-value/citation        "ITA §127.1 — CCPC enhanced-rate limit $3M (2010 → 2024-12-15)"}

   {:parameter-value/parameter      [:parameter/code "CA.Federal.SRED.ccpc-expenditure-limit"]
    :parameter-value/effective-from #inst "2024-12-15"
    :parameter-value/decimal-value  6000000M
    :parameter-value/citation       "ITA §127.1 — CCPC enhanced-rate limit raised to $6M for TYs beginning after 2024-12-15 (Fall 2024 Economic Statement)"}

   ;; --------------------------------------------------------------------
   ;; Ontario — 11.5% general / 3.2% small / $500k since 2020-01-01
   ;; --------------------------------------------------------------------
   {:parameter-value/parameter      [:parameter/code "CA.ON.CIT.general-rate"]
    :parameter-value/effective-from #inst "2018-07-01"
    :parameter-value/decimal-value  0.115M
    :parameter-value/citation       "Ontario general CIT rate 11.5% since 2018-07-01"}
   ...
   ;; --------------------------------------------------------------------
   {:parameter-value/parameter      [:parameter/code "CA.BC.CIT.general-rate"]
    :parameter-value/effective-from #inst "2018-01-01"
    :parameter-value/decimal-value  0.12M
    :parameter-value/citation       "BC general CIT rate 12% since 2018-01-01 (raised from 11%)"}

   {:parameter-value/parameter      [:parameter/code "CA.BC.CIT.sbd-rate"]
    :parameter-value/effective-from #inst "2017-04-01"
    :parameter-value/decimal-value  0.02M
    :parameter-value/citation       "BC small-business CIT rate 2% since 2017-04-01"}

   {:parameter-value/parameter      [:parameter/code "CA.BC.CIT.sbd-limit"]
    :parameter-value/effective-from #inst "2009-01-01"
    :parameter-value/decimal-value  500000M
    :parameter-value/citation       "BC small-business limit $500k (matches federal)"}

   ;; --------------------------------------------------------------------
   ;; Alberta — 8% general / 2% small / $500k
   ;; --------------------------------------------------------------------
   {:parameter-value/parameter      [:parameter/code "CA.AB.CIT.general-rate"]
    :parameter-value/effective-from #inst "2020-07-01"
    :parameter-value/decimal-value  0.08M
    :parameter-value/citation       "Alberta general CIT rate 8% since 2020-07-01 (Job Creation Tax Cut, accelerated from 12%)"}

   {:parameter-value/parameter      [:parameter/code "CA.AB.CIT.sbd-rate"]
    :parameter-value/effective-from #inst "2017-01-01"
    :parameter-value/decimal-value  0.02M
    :parameter-value/citation       "Alberta small-business CIT rate 2% since 2017-01-01"}

   {:parameter-value/parameter      [:parameter/code "CA.AB.CIT.sbd-limit"]
    :parameter-value/effective-from #inst "2009-01-01"
    :parameter-value/decimal-value  500000M
    :parameter-value/citation       "Alberta small-business limit $500k (matches federal)"}])
...
(def provisions
  "CA CIT statutory provisions encoded for the `kontor.statute`

(ns kontor.l10n-ca.closing
  "Canadian fiscal-year close — rolls P&L accounts to retained
   earnings using the kontor default account convention.
...
(defn- account-by-code [db code]
  (kacct/resolve-code db code {:context "CA year-end closing"}))
...
(defn close-ca-fiscal-year!
  "Close a CA fiscal-year period using the kontor default
   account convention.

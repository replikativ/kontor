(ns kontor.l10n-ca.cgt-provider-test
  "Tests for the CA CGT provider (ADR-102 + ADR-101).

   Covers the headline CA CGT mechanics:
     §1  Plumbing — DisposalProvider wired; empty case; kind validation
     §2  50% inclusion — the base case (taxable = 0.5 × gain)
     §3  LCGE — QSBC shelter consumption + per-call cap;

(ns kontor.l10n-ca.y2024.t1-test
  "Tests for the federal T1 core (TY2024).
   ...
   The Haskell project `blamario/canadian-income-tax` is used as a
   numerical oracle out-of-band; we do not lift any of its code or
   fixtures (license incompatibility per ADR-015)."

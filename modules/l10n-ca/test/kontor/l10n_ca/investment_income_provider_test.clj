(ns kontor.l10n-ca.investment-income-provider-test
  "Tests for the CA investment-income provider (research note 152).

   Coverage:
     §1  Eligible dividend gross-up + federal DTC + ON provincial DTC
         (Ms. Chen-style — note 152 §2 Example A, ON variant)
     ...
     §6  Mixed Ms Chen BC portfolio — note 152 §2 Example A
...
;; ============================================================================
;; §6. Ms Chen, BC resident — note 152 §2 Example A
;; ============================================================================

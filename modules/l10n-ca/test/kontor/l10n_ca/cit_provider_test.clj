(ns kontor.l10n-ca.cit-provider-test
  "CA corporate income tax provider tests — ADR-107. Validates that
   ...
   `kontor.tax.statute/apply-provisions` fold) computes real CA T2
   against the published CRA authority worked example. Sibling test to
   `kontor.l10n-de.cit-provider-test`; same structure, CA-specific
   content.

   Cases:
     §1  CRA Canada Corporate Tax worked example
 — Acme Widgets Co., a CCPC with
   ...
   Sources:
     ...
     - Published authority worked example
     - Published rate tables (corporate tax 2025)"
...
;; ============================================================================
;; §1. CRA worked example — Acme Widgets Co.
;; ============================================================================

(deftest cra-worked-example-ccpc-on-ab-allocation
  (testing "Acme Widgets Co. CCPC, 620k taxable, ON 65% / AB 35%"
...
(deftest on-2026-bill-12-transition
  ;; Note 126 + + — Ontario Bill 12 (RA Nov 2025;

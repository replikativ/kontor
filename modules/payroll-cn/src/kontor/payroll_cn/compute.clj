(ns kontor.payroll-cn.compute
  "CN payroll compute providers — file-ingest CSV adapters for CN
   payroll engines (Yonyou / Kingdee / Beisen).
...
;; ============================================================================
;; Default column mappings per engine
;; ============================================================================

(def yonyou-default-column-mapping
  "Yonyou default column names. Per public documentation the wage-export
   carries the CN canonical labels."
  {:employee-id-col "员工编号"
   :pay-element-col "工资项目"
   :amount-col      "金额"})

(def kingdee-default-column-mapping
  "Kingdee default column names. Per public documentation the export
   uses 薪酬项目 as the wage-type column."
  {:employee-id-col "员工编号"
   :pay-element-col "薪酬项目"
   :amount-col      "金额"})

(def beisen-default-column-mapping
  "Beisen default column names. The export favours English-keyed columns."

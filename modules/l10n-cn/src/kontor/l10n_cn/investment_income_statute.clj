(ns kontor.l10n-cn.investment-income-statute
  "CN investment-income tax — IIT category 7 (利息、股息、红利所得) +
   EIT inter-TRR exemption — encoded as `kontor.tax.statute` data per
   ADR-101. 
...
(def provisions
  "CN investment-income provisions encoded for the `kontor.tax.statute`

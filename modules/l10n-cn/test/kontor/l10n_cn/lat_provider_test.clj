(ns kontor.l10n-cn.lat-provider-test
  "Tests for the CN Land Appreciation Tax provider —.6 +
   §5.3."
...
(deftest lat-individual-residential-out-of-scope-by-construction
  (testing "Individual residential sales (Caishui [2008] 137) are out-of-scope for LAT — they ride :cn-residential and are picked up by the IIT provider, never recorded under :cn-developer-real-estate. Note 145 §1."
    (let [conn (fresh)]

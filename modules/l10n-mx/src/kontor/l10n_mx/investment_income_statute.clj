...
(def parameters
  ...
  [{:parameter/code         "MX.INV.dividendos.isr-adicional-rate"
    :parameter/label        "Art. 140 LISR — 10 % ISR Adicional on PF dividends (post-2014 CUFIN)"
    :parameter/jurisdiction :mx
    :parameter/unit         :rate
    :parameter/concept-iri  "https://mexico.justia.com/federales/leyes/ley-del-impuesto-sobre-la-renta/titulo-iv/capitulo-viii/"}

   {:parameter/code         "MX.INV.dividendos.gross-up-factor"
    :parameter/label        "Art. 140 LISR — grossing-up factor (= 1 / (1 − CIT 0.30))"
    :parameter/jurisdiction :mx
    :parameter/unit         :rate
    :parameter/concept-iri  "https://mexico.justia.com/federales/leyes/ley-del-impuesto-sobre-la-renta/titulo-iv/capitulo-viii/"}

   {:parameter/code         "MX.INV.dividendos.corporate-isr-credit-rate"
    :parameter/label        "Art. 140 LISR — deemed corporate-ISR credit fraction (30 %)"
    :parameter/jurisdiction :mx
    :parameter/unit         :rate
    :parameter/concept-iri  "https://mexico.justia.com/federales/leyes/ley-del-impuesto-sobre-la-renta/titulo-iv/capitulo-viii/"}

   {:parameter/code         "MX.INV.bank-interest.wht-rate"
    :parameter/label        "Art. 54 LISR + annual LIF — bank-interest provisional WHT (on daily-avg balance)"
    :parameter/jurisdiction :mx
    :parameter/unit         :rate
    :parameter/concept-iri  "https://mexico.justia.com/federales/leyes/ley-del-impuesto-sobre-la-renta/titulo-iv/capitulo-vi/"}

   {:parameter/code         "MX.INV.nr-dividend.base-rate"
    :parameter/label        "Art. 164 LISR — non-resident dividend base-rate WHT (10 %)"
    :parameter/jurisdiction :mx
    :parameter/unit         :rate
    :parameter/concept-iri  "https://mexico.justia.com/federales/leyes/ley-del-impuesto-sobre-la-renta/titulo-v/"}

   {:parameter/code         "MX.INV.foreign-tax-credit-cap-rate"
    :parameter/label        "Art. 5 LISR — foreign-tax credit per-country basket cap rate (1.0 = full)"
    :parameter/jurisdiction :mx
    :parameter/unit         :rate
    :parameter/concept-iri  "https://mexico.justia.com/federales/leyes/ley-del-impuesto-sobre-la-renta/titulo-i/"}])

(def parameter-values
  "MX investment-income parameter values."
  [;; 10 % ISR Adicional — in effect since 2014-01-01 (post-2014 CUFIN).
   {:parameter-value/parameter      [:parameter/code "MX.INV.dividendos.isr-adicional-rate"]
    :parameter-value/effective-from #inst "2014-01-01"
    :parameter-value/decimal-value  0.10M
    :parameter-value/citation       "Art. 140 LISR — 10 % ISR Adicional sobre Dividendos; SCJN Pleno 8 Jan 2026 confirmed constitutionality"}

   ;; Gross-up factor 1.4286 — same effective date as the CIT 30 %.
   {:parameter-value/parameter      [:parameter/code "MX.INV.dividendos.gross-up-factor"]
    :parameter-value/effective-from #inst "2014-01-01"
    :parameter-value/decimal-value  1.4286M
    :parameter-value/citation       "Art. 140 LISR — factor 1.4286 = 1 / (1 − 0.30 CIT)"}

   ;; Corporate-ISR credit rate (the 30 % factor-credit).
   {:parameter-value/parameter      [:parameter/code "MX.INV.dividendos.corporate-isr-credit-rate"]
    :parameter-value/effective-from #inst "2014-01-01"
    :parameter-value/decimal-value  0.30M
    :parameter-value/citation       "Art. 140 LISR — deemed corporate-ISR credit (= CIT rate × grossed-up dividend)"}

   ;; Bank-interest WHT — the LIF 2026 cliff: 0.50 % until 2025-12-31,
   ;; then 0.90 % from 2026-01-01 (80 % hike confirmed in note 157).
   {:parameter-value/parameter      [:parameter/code "MX.INV.bank-interest.wht-rate"]
    :parameter-value/effective-from #inst "2023-01-01"
    :parameter-value/effective-until #inst "2026-01-01"
    :parameter-value/decimal-value  0.0050M
    :parameter-value/citation       "Art. 54 LISR + LIF 2023/2024/2025 — provisional WHT 0.50 % on daily-avg principal"}

   {:parameter-value/parameter      [:parameter/code "MX.INV.bank-interest.wht-rate"]
    :parameter-value/effective-from #inst "2026-01-01"
    :parameter-value/decimal-value  0.0090M
    :parameter-value/citation       "LIF 2026 — provisional WHT raised to 0.90 % (note 157 §1.2.1)"}

   ;; Non-resident dividend art. 164 base rate.
   {:parameter-value/parameter      [:parameter/code "MX.INV.nr-dividend.base-rate"]
    :parameter-value/effective-from #inst "2014-01-01"
    :parameter-value/decimal-value  0.10M
    :parameter-value/citation       "Art. 164 LISR — non-resident dividend WHT 10 % (treaty caps apply separately)"}

   ;; Foreign tax credit cap multiplier — 1.0 (full).
   {:parameter-value/parameter      [:parameter/code "MX.INV.foreign-tax-credit-cap-rate"]
    :parameter-value/effective-from #inst "2014-01-01"
    :parameter-value/decimal-value  1.00M
    :parameter-value/citation       "Art. 5 LISR — foreign tax credit capped at MX ISR otherwise due; per-country basket"}])

...
(def parameter-values
  ...
  [;; 10 % ISR Adicional — in effect since 2014-01-01 (post-2014 CUFIN).
   ...
   ;; then 0.90 % from 2026-01-01 (80 % hike per LIF 2026).
   ...
   {:kontor.parameter-value/parameter      [:kontor.parameter/code "MX.INV.bank-interest.wht-rate"]
    ...
    :kontor.parameter-value/citation       "LIF 2026 — provisional WHT raised to 0.90 %"}
...
(def provisions
  "MX investment-income provisions for the `kontor.tax.statute` evaluator.
   ...
   decision into ctx via `:cufin-bucket` (kontor.tax.statute condition

(ns kontor.l10n-br.cgt-statute
  "BR capital-gains tax — Ganho de Capital + Renda Variável — encoded
   as `kontor.statute` data per ADR-101. Research note 130.
   ...
   - **Lane C — PJ** — capital gains fold into IRPJ + CSLL at the
     ...
     presumption base — V1 supports only Lucro Real (note 130 §1.3).

   Per note 130 §3, the four-bracket PF ladder is recorded as
   ...
   OUT capital gains (note 130 §1.5); no CGT-provider impact.
   ...
   per note 130 §6, both stay record-shaped in the provider; only
...
(def parameters
  ...
  [;; --- Lane A — PF ganho de capital — the four-bracket ladder -------------
   {:parameter/code         "BR.CGT.PF.ganho-capital-brackets"
    :parameter/label        "PF ganho de capital — tabela progressiva (Lei 13.259/2016 art. 21)"
    :parameter/jurisdiction :br
    :parameter/unit         :bracket-scale
    :parameter/concept-iri  "https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2016/lei/l13259.htm"}

   ;; --- Lane A — pequeno-valor R$ 35k monthly aggregate exemption ----------
   {:parameter/code         "BR.CGT.PF.pequeno-valor-cap"
    :parameter/label        "PF pequeno-valor — monthly aggregate sale-price isenção (Lei 9.250/95 art. 22)"
    :parameter/jurisdiction :br
    :parameter/unit         :amount-money
    :parameter/concept-iri  "https://www.planalto.gov.br/ccivil_03/leis/l9250.htm"}

   ;; --- Lane B — PF renda variável swing-trade rate ------------------------
   {:parameter/code         "BR.CGT.PF.renda-variavel.swing-rate"
    :parameter/label        "PF renda variável — swing-trade rate (Lei 11.033/2004 art. 2)"
    :parameter/jurisdiction :br
    :parameter/unit         :rate
   ...
   {:parameter/code         "BR.CGT.PF.renda-variavel.day-rate"
    :parameter/label        "PF renda variável — day-trade rate (Lei 11.033/2004 art. 2)"
    :parameter/jurisdiction :br
    :parameter/unit         :rate
    :parameter/concept-iri  "https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2004/lei/l11033.htm"}
   ...
   {:parameter/code         "BR.CGT.PF.bolsa-swing-cap"
    :parameter/label        "PF bolsa swing — monthly aggregate sale-price isenção (Lei 11.033/2004 art. 3 I)"
    :parameter/jurisdiction :br
    :parameter/unit         :amount-money
    :parameter/concept-iri  "https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2004/lei/l11033.htm"}

   ;; --- Lane B — IRRF dedo-duro swing rate (broker prepayment) -------------
   {:parameter/code         "BR.CGT.PF.irrf.swing-rate"
    :parameter/label        "IRRF dedo-duro — swing-trade broker withholding (IN-RFB-1585/2015 art. 63)"
    :parameter/jurisdiction :br
    :parameter/unit         :rate
    :parameter/concept-iri  "https://normas.receita.fazenda.gov.br/sijut2consulta/link.action?visao=anotado&idAto=70004"}

   ;; --- Lane B — IRRF dedo-duro day-trade rate -----------------------------
   {:parameter/code         "BR.CGT.PF.irrf.day-rate"
    :parameter/label        "IRRF dedo-duro — day-trade broker withholding (IN-RFB-1585/2015 art. 63)"
    :parameter/jurisdiction :br
    :parameter/unit         :rate
    :parameter/concept-iri  "https://normas.receita.fazenda.gov.br/sijut2consulta/link.action?visao=anotado&idAto=70004"}

   ;; --- Lane A — art. 39 residence-reinvest window (180 days) --------------
   {:parameter/code         "BR.CGT.PF.art39-reinvest-days"
    :parameter/label        "PF art. 39 residence-reinvestment window (days)"
    :parameter/jurisdiction :br
    :parameter/unit         :days
    :parameter/concept-iri  "https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2005/lei/l11196.htm#art39"}])
...
(def parameter-values
  ...
  [;; --- PF pequeno-valor R$ 35k monthly cap (Lei 9.250/95 art. 22) ---------
   {:parameter-value/parameter      [:parameter/code "BR.CGT.PF.pequeno-valor-cap"]
    :parameter-value/effective-from #inst "1996-01-01"
    :parameter-value/decimal-value  35000M
    :parameter-value/citation       "Lei 9.250/1995 art. 22 — R$ 35 000 monthly aggregate price isenção"}

   ;; --- PF renda variável swing 15 % (Lei 11.033/2004 art. 2) -------------
   {:parameter-value/parameter      [:parameter/code "BR.CGT.PF.renda-variavel.swing-rate"]
    :parameter-value/effective-from #inst "2005-01-01"
    :parameter-value/decimal-value  0.15M
    :parameter-value/citation       "Lei 11.033/2004 art. 2 II — 15 % swing-trade rate"}

   ;; --- PF renda variável day-trade 20 % (Lei 11.033/2004 art. 2) ----------
   {:parameter-value/parameter      [:parameter/code "BR.CGT.PF.renda-variavel.day-rate"]
    :parameter-value/effective-from #inst "2005-01-01"
    :parameter-value/decimal-value  0.20M
    :parameter-value/citation       "Lei 11.033/2004 art. 2 § 1 — 20 % day-trade rate"}

   ;; --- PF bolsa swing R$ 20k monthly cap (Lei 11.033/2004 art. 3 I) -------
   {:parameter-value/parameter      [:parameter/code "BR.CGT.PF.bolsa-swing-cap"]
    :parameter-value/effective-from #inst "2005-01-01"
    :parameter-value/decimal-value  20000M
    :parameter-value/citation       "Lei 11.033/2004 art. 3 I — R$ 20 000 monthly aggregate isenção for ações swing"}

   ;; --- IRRF dedo-duro swing 0.005 % --------------------------------------
   {:parameter-value/parameter      [:parameter/code "BR.CGT.PF.irrf.swing-rate"]
    :parameter-value/effective-from #inst "2005-01-01"
    :parameter-value/decimal-value  0.00005M
    :parameter-value/citation       "IN-RFB-1585/2015 art. 63 II — 0,005 % swing broker withholding"}

   ;; --- IRRF dedo-duro day-trade 1 % --------------------------------------
   {:parameter-value/parameter      [:parameter/code "BR.CGT.PF.irrf.day-rate"]
    :parameter-value/effective-from #inst "2005-01-01"
    :parameter-value/decimal-value  0.01M
    :parameter-value/citation       "IN-RFB-1585/2015 art. 63 I — 1 % day-trade broker withholding"}

   ;; --- art. 39 residence-reinvest window — 180 days ----------------------
   {:parameter-value/parameter      [:parameter/code "BR.CGT.PF.art39-reinvest-days"]
    :parameter-value/effective-from #inst "2005-11-21"
    :parameter-value/decimal-value  180M
    :parameter-value/citation       "Lei 11.196/2005 art. 39 — 180-day reinvestment window"}])
...
(def parameter-brackets
  "PF ganho-capital brackets — Lei 13.259/2016 art. 21, effective
   ...
   `kontor.tax-schedule/progressive` — first bracket up to R$ 5M,
   second up to R$ 10M, third up to R$ 30M, fourth open."
  [{:parameter-bracket/parameter       [:parameter/code "BR.CGT.PF.ganho-capital-brackets"]
    :parameter-bracket/index            0
    :parameter-bracket/rate             0.15M
    :parameter-bracket/upper            5000000M
    :parameter-bracket/effective-from   #inst "2017-01-01"}
   {:parameter-bracket/parameter       [:parameter/code "BR.CGT.PF.ganho-capital-brackets"]
    :parameter-bracket/index            1
    :parameter-bracket/rate             0.175M
    :parameter-bracket/upper            10000000M
    :parameter-bracket/effective-from   #inst "2017-01-01"}
   {:parameter-bracket/parameter       [:parameter/code "BR.CGT.PF.ganho-capital-brackets"]
    :parameter-bracket/index            2
    :parameter-bracket/rate             0.20M
    :parameter-bracket/upper            30000000M
    :parameter-bracket/effective-from   #inst "2017-01-01"}
   ;; The open top band — `:parameter-bracket/upper` is omitted per the
   ;; schema's "Absent ⇒ open top band" convention (bigdec attr cannot
   ;; carry nil).
   {:parameter-bracket/parameter       [:parameter/code "BR.CGT.PF.ganho-capital-brackets"]
    :parameter-bracket/index            3
    :parameter-bracket/rate             0.225M
    :parameter-bracket/effective-from   #inst "2017-01-01"}])
...
(def provisions
  "BR CGT v1 ships ZERO provisions — every regime call lives in the
   provider, per note 130 §6: the art. 39 residence-reinvestment
   exemption is condition-rich (depends on `:residence?` +
   `:rollover-into-asset` + 180-day window — none of which a literal
   `:provision/condition` can express today without per-disposal
   ...
   `parameter-brackets-at`. A future iteration (note 130 §6 plus the
   IRRF substrate gap §4 B) may migrate the art. 39 residence-
...
(defn install!
  "Install BR CGT statute (parameters + values + brackets) into `conn`.
   Idempotent — `:parameter/code` is the unique identity attr."
  [conn]

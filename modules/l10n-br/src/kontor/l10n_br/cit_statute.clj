(ns kontor.l10n-br.cit-statute
  "BR corporate income tax — IRPJ + CSLL — encoded as `kontor.tax.statute`
   data per ADR-101. The second-to-fourth end-to-end consumer of the
   statute-as-data substrate (after DE / FR / JP / CA).
   ...
   public-domain per Lei 9.610/1998 art. 8. All citations point at
   planalto.gov.br; values cross-checked against authority-published
   worked examples."
...
(def parameter-values
  ...
  [;; IRPJ rates — stable since 1996
   ...
   ;; CSLL bancos — three windows (bitemporally critical
   ;; via Lei 14.183/2021)
...
(def provisions
  "BR CIT statutory provisions encoded for the `kontor.tax.statute`
   ...
   fires under Real + Presumido + Arbitrado,3)."
  ...
  [;; ====================================================================
   ...
   ;;3 (the law treats both as art. 13).
   ;; ====================================================================
